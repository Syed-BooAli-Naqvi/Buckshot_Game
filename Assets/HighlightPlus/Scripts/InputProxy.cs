...
namespace HighlightPlus {
    ...
    public static class InputProxy {
        ...
        public static bool GetMouseButtonDown(int buttonIndex) {
            return ControlFreak2.CF2Input.GetMouseButtonDown(buttonIndex);
        }

        public static int touchCount {
            get { return ControlFreak2.CF2Input.touchCount; }
        }

        public static int GetFingerIdFromTouch(int touchIndex) {
            return ControlFreak2.CF2Input.GetTouch(touchIndex).fingerId;
        }

        public static bool GetKeyDown(string name) {
            return ControlFreak2.CF2Input.GetKeyDown(name);
        }
