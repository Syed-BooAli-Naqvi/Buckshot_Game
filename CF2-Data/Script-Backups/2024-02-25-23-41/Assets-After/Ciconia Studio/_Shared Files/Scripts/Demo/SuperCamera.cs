...
public class SuperCamera : MonoBehaviour {
	...
	void Update () {
        ...
        if (ControlFreak2.CF2Input.GetKeyDown(resetShortcut))
        {
            Camera.main.transform.position = oldCamPos;
            Camera.main.transform.rotation = oldCamRot;
        }

        float wheel = ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel");
        if (wheel != 0f)
        {
        ...
        if (!ControlFreak2.CF2Input.GetMouseButton(0) && !ControlFreak2.CF2Input.GetMouseButton(2))
        {
        ...
        if (ControlFreak2.CF2Input.GetMouseButtonDown(0) || ControlFreak2.CF2Input.GetMouseButtonDown(2))
        {
